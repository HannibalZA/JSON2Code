...
I just got tired of browsing online for converters and made it instead. Can be run anywhere, core functionality has no dependencies (except for js-yaml(https://github.com/nodeca/js-yaml) to parse yaml output)
